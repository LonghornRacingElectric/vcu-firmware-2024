...
void wheelspeeds_init() {
    can_addInbox(WHS_VCU_DISP_1, &whs_fr_inbox);
    can_addInbox(WHS_VCU_DISP_2, &whs_fl_inbox);
    can_addInbox(WHS_VCU_DISP_3, &whs_br_inbox);
    can_addInbox(WHS_VCU_DISP_4, &whs_bl_inbox);
}
